...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dpram is
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_0_0 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_10_10 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_11_11 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_12_12 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_13_13 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_14_14 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_15_15 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_1_1 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_2_2 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_3_3 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_4_4 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_5_5 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_6_6 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_7_7 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_8_8 : label is 4096;
  ...
  attribute RTL_RAM_BITS of ram_reg_128_255_9_9 : label is 4096;
...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000AAAAAAAA"
    )
        port map (
...
ram_reg_0_127_1_1: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000CCCCCCCC"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(1),
...
ram_reg_0_127_2_2: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000F0F0F0F0"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(2),
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000FF00FF00"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(3),
...
ram_reg_0_127_4_4: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000FFFF0000"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(4),
