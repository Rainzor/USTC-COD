...
#
# Generated by export_simulation on Wed Apr 20 20:49:47 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './data_mem2.sh' script.

./data_mem2.sh -reset_run
...
./data_mem2.sh -noclean_files

For more information on the script, please type './data_mem2.sh -help'.
