...
#
# Generated by export_simulation on Wed Apr 13 18:41:50 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './inst_mem2.sh' script.

./inst_mem2.sh -reset_run
...
./inst_mem2.sh -noclean_files

For more information on the script, please type './inst_mem2.sh -help'.
